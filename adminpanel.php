			...
			<section id="main" class="wrapper">
				<div class="inner">
					<header class="align-center">
						<h1>Admin Panel</h1>
						<p></p>
                    <li><a href="adminpanel.php" class="button special" style="width:320px">Admin Panel</a></li>
                    <li><a href="adminstore.php" class="button special" style="width:320px">Store Controls</a></li>
                    <li><a href="admin.php" class="button special" style="width:320px">Admin Dashboard</a></li>
					<li><a href="admincouponcode.php" class="button special" style="width:320px">Create Coupon Code</a></li>
					<li><a href="adminviewdelcodes.php" class="button special" style="width:320px">View/Del Coupon Code</a></li>
                    <li><a href="adminaccountlist.php" class="button special" style="width:320px">View Account List</a></li>
                    <li><a href="admincompletedorders.php" class="button special" style="width:320px">View Completed Orders</a></li>
                    <li><a href="admincancelledorders.php" class="button special" style="width:320px">View Canceled Orders</a></li>
					</header>
			</section>
