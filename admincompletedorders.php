...
<table>
		...
		<tbody>
<?php
        if($user_info = mysqli_query($conn,"SELECT * FROM completedorderhistory"))
{
  while ($row5 = mysqli_fetch_array($user_info))    
  {
?>
        
		<tr>
        	<td scope="row" data-label="ID"><?php echo $row5['id'] ?></td>
			<td data-label="Order ID"><?php echo $row5['orderid'] ?></td>
			<td data-label="FirstName"><?php echo $row5['firstname'] ?></td>
			<td data-label="LastName"><?php echo $row5['lastname'] ?></td>
			<td data-label="PhoneNumber"><?php echo $row5['phonenumber'] ?></td>
			<td data-label="Delivery Address"><?php echo $row5['deliveryaddress'] ?></td>
            <td data-label="PayType"><?php echo $row5['paytype'] ?></td>
            <td data-label="Instructions"><?php echo $row5['instructions'] ?></td>
            <td data-label="Order Location"><?php echo $row5['orderlocation'] ?></td>
            <td data-label="Username"><?php echo $row5['username'] ?></td>
            <td data-label="Status"><?php echo $row5['status'] ?></td>
            <td data-label="Order Name"><?php echo $row5['ordername'] ?></td>
            <td data-label="Made Time"><?php echo $row5['madetime'] ?></td>
            <td data-label="Completed Time"><?php echo $row5['completedtime'] ?></td>
            <td data-label="Discount Used"><?php echo $row5['discount'] ?></td>
            <td data-label="Price"><?php echo $row5['price'] ?></td>
		</tr>
<?php
}}}
?>
