...
<table>
		...
		<tbody>
<?php
        if($user_info = mysqli_query($conn,"SELECT * FROM users"))
{
  while ($row4 = mysqli_fetch_array($user_info))    
  {
?>
        
		<tr>
        	<td scope="row" data-label="Account ID"><?php echo $row4['id'] ?></td>
			<td data-label="Username"><?php echo $row4['username'] ?></td>
			<td data-label="UserLevel"><?php echo $row4['userlevel'] ?></td>
			<td data-label="FirstName"><?php echo $row4['firstname'] ?></td>
			<td data-label="LastName"><?php echo $row4['lastname'] ?></td>
			<td data-label="PhoneNumber"><?php echo $row4['phone'] ?></td>
            <td data-label="Email"><?php echo $row4['email'] ?></td>
		</tr>
<?php
}}}
?>
